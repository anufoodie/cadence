...
2026-06-23T17:44:09-0700 | claude-code-2026-06-23-host-commit-layered-extraction | note | worktree hygiene: retired 2 landed HOST-COMMIT-RECIPE files + empty examples/grove scaffold; committed Cowork chronicle; exact-path deletes (core.ignorecase=true) | chronicle:claude-code-2026-06-23-host-commit-layered-extraction.md
